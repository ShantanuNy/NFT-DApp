...
function NFTDropPage({ collection }: Props) {
  ...
  return (
    <div className="flex h-screen flex-col lg:grid lg:grid-cols-10">
      ...
      {/* Left */}
      <div className="bg-gradient-to-br from-white to-black pt-10 shadow-2xl lg:col-span-4 lg:pt-0">
        <div className="flex flex-col items-center justify-center py-2 lg:min-h-screen">
          <div className="rounded-xl bg-gradient-to-br from-yellow-400 to-black p-3">
            <img
      ...
      <div className="flex flex-1 flex-col p-12 lg:col-span-6">
        ...
        {address && (
          <p className="text-center text-sm text-rose-400">
            YOU'RE CONNECTED WITH THIS WALLET.. . . {address.substring(0, 5)}...
        ...
        <button
          ...
          className="h-16 w-full rounded-full bg-black text-white disabled:bg-gray-400"
          onClick={mintNft}
        >
          {loading ? (
            <>Loading...</>
